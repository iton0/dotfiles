...
swayidle -w \
    ...
    timeout 600 'swaylock -f -i /usr/share/backgrounds/default-dark.png && playerctl stop' \
    timeout 900 'systemctl suspend' \
    before-sleep 'swaylock -f -i /usr/share/backgrounds/default-dark.png && playerctl stop'
